...
//! * [`apic`] — local APIC: spurious vector, TPR, IPI delivery, and the
//!   periodic timer that drives the scheduler clock tick.
//! * [`acpi`] — RSDP/XSDT/MADT table discovery; the MADT's LAPIC entries
//!   are the machine's processor list for `ke::smp`.
